...
const OurTeam = async () => {
  ...
  <p className='text-sm lg:text-lg md:lg:text-base  leading-[30px] mt-3'>
    {t('subtitle')}
  </p>
          </div>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-12'>
            <div className='flex flex-col col items-center justify-center gap-5'>
                ...
                <p className='font-bold xl:text-[19px] lg:lg:text-base'>الاعتماد على أحدث التقنيات</p>
            </div>
             <div className='flex flex-col col items-center justify-center gap-5'>
                <Image src = '/images/team-1.png' alt='team' width={304} height={206} />
                <p className='font-bold lg:text-[19px] lg:text-base text-sm'>الاعتماد على أحدث التقنيات</p>
            </div>
             <div className='flex flex-col col items-center justify-center gap-5'>
                <Image src = '/images/team-1.png' alt='team' width={304} height={206} />
                <p className='font-bold lg:text-[19px] lg:text-base text-sm'>الاعتماد على أحدث التقنيات</p>
